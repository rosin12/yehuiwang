...
function core_md5(n, t) {
	var e; n[t >> 5] |= 128 << t % 32, n[(t + 64 >>> 9 << 4) + 14] = t;
	var i = 1732584193, r = -271733879, u = -1732584194, f = 271733878; 
...
function core_hmac_md5(n, t) {
	var r = str2binl(n), u, f, i, e;
	for (r.length > 16 && (r = core_md5(r, n.length * chrsz)), u = Array(16), f = Array(16), i = 0; i < 16; i++) u[i] = r[i] ^ 909522486, f[i] = r[i] ^ 1549556828;
	return e = core_md5(u.concat(str2binl(t)), 512 + t.length * chrsz), core_md5(f.concat(e), 640) 
	} 
